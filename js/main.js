    ...
    e(document).on(
      ...
      t("#contact .contact-section", function () {
        e("#contact .contact-section .contact-form").on("submit", function (t) {
          ...
          t.preventDefault(),
            a.html("Sending...").addClass("wait").prop("disabled", !0);
          const enteredValue = new FormData(t.target);
          const formJSON = Object.fromEntries(enteredValue.entries());
          const JsonData = JSON.stringify(formJSON);
          
            fetch("https://protfolio-backend-ten.vercel.app/", {
              method: "POST",
              body: JsonData,
              headers: {
              ...
              .then((json) => {
                ...
                o
                  .addClass("success")
                  .html(
                    `Thank you ${json.data.name} for your message. It has been sent successfully. Kindly, check your mail for confirmation.`
                  )
                  .fadeIn(200),
                  setTimeout(function () {
              ...
              .catch((error) => {
                ...
                o
                  .addClass("error")
                  .html(
                    "Opps, There is server error. Please try again after some time!"
                  )
                  .fadeIn(200),
                  setTimeout(function () {
