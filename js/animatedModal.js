  ...
  a.fn.animatedModal = function(n) {
      ...
      var e = a.extend({
          ...
          afterOpen: function() {
              ...
              a("html").add(i).css("marginRight", (n = a("<div>").css({
                  visibility: "hidden",
                  width: 100,
                  overflow: "scroll"
              }).appendTo("body"),
      ...
      t.click((function(a) {
          a.preventDefault(),
          d == l && (s.hasClass(e.modalTarget + "-off") && (s.removeClass(e.animatedOut),
          s.removeClass(e.modalTarget + "-off"),
          s.addClass(e.modalTarget + "-on")),
          s.hasClass(e.modalTarget + "-on") && (e.beforeOpen(),
          s.css({
              opacity: e.opacityIn,
              "z-index": e.zIndexIn
          }),
          s.addClass(e.animatedIn),
          s.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", f)))
      }
      )),
      i.click((function(a) {
          a.preventDefault(),
          e.beforeClose(),
          s.hasClass(e.modalTarget + "-on") && (s.removeClass(e.modalTarget + "-on"),
          s.addClass(e.modalTarget + "-off")),
          s.hasClass(e.modalTarget + "-off") && (s.removeClass(e.animatedIn),
          s.addClass(e.animatedOut),
          s.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", m))
      }
      ))
  }
}(jQuery);
